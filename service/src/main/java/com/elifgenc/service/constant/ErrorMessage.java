...
public enum ErrorMessage {
    ...
    REFRESH_TOKEN_NOT_FOUND("TODO-004", "Yenileme anahtarı bulunamadı.", "Yenileme anahtarı bulunamadı."),
    REFRESH_TOKEN_NOT_VALID("TODO-005", "Yenileme anahtarı geçerliliğini yitirmiştir.", "Yenileme anahtarı geçerliliğini yitirmiştir.");
